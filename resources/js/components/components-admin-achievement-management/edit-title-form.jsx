...
export default function EditTitleForm({ achievement }) {
 ...
 return (
  <Dialog open={open} onOpenChange={setOpen}>
   <DialogTrigger asChild>
    <Button variant={'ghost'} className={'w-full justify-start px-2'}>Edit title</Button>
   </DialogTrigger>
   <DialogContent>
    <form onSubmit={updateAchievement} className="space-y-5">
     <DialogHeader>
