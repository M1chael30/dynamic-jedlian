  ...
  return (
    <section className="flex flex-col items-center justify-center">
      <div className="grid py-5 md:grid-cols-2">
        <motion.div variants={fadeVariants} initial="hidden" whileInView="show" className="flex items-center justify-center">
          <img
            draggable="false"
            src={'images/geo-footprint.png'}
            alt="pilipinas"
            className="h-auto w-full max-w-full object-contain select-none md:w-auto"
          />
        </motion.div>
        <motion.div variants={containerVariants} className="mx-5 flex flex-col items-center justify-center">
          <motion.h1
          ...
          <motion.p variants={fadeRightSlowVariants} initial="hidden" whileInView="show" className="text-description p-5 text-center md:text-left">
            {data[2].content}
          </motion.p>
        </motion.div>
      </div>
