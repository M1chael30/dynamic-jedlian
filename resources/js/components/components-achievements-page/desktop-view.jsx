                  ...
                  <Fragment key={id}>
                    ...
                    {achievement_image ? (
                      <div className="aspect-video overflow-hidden rounded-xl border border-yellow-400">
                        <img src={`/storage/${achievement_image?.image_filename}`} alt="nakamit mo" className="h-full w-full select-none" />
                      </div>
                    ) : (
                      <div className="aspect-video overflow-hidden rounded-xl flex justify-center items-center">
                        <img src={`/images/empty.png`} alt="nakamit mo" className="h-3/4 w-1/2 select-none" />
                      </div>
                    )}
                  </Fragment>
                ))}
