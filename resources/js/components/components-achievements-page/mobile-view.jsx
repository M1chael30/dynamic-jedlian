          ...
          .map((achievement) => (
            <div key={achievement.id}>
              <motion.div
                ...
                className={
                  cn(
                    'flex justify-center items-center gap-5 relative h-auto',
                    achievement.id % 2 == 0 ? "" : "flex-row-reverse"
                  )
                }
              >
                <div className="bg-[radial-gradient(circle_at_75%,#c89116,#c89116,#cfceaa)] text-transparent bg-clip-text"
                >
